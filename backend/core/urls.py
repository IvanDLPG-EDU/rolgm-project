...
from .views import RoomListAPIView, RoomSearchView,RoomDirectoryAPIView, DetailedRoomAPIView,GetPlayersAndCharactersAPIView
...
urlpatterns = [
    ...
    re_path(r'^room/(?P<room_name>[\w\s]+)/(?P<room_id>[A-Z\d]+)/my-characters/$', GetPlayersAndCharactersAPIView.as_view(), name='user_characters')
