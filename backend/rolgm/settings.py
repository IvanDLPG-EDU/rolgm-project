...
ALLOWED_HOSTS = [f'{config("SERVER_HOST")}', f'{config("CLIENT_HOST")}']
...
DOMAIN_CLIENT = config('DOMAIN_CLIENT')
...
AUTH_USER_MODEL = 'authentication_core.User'
